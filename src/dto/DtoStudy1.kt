...
// DTO(Date Transfer Object) 와 VO(Value Object)
// 공통점
// 데이터를 캡슐화하여 데이터와 관련된 정보를 하나의 단위로 묶어준다.
// 불변성을 가지는데, VO는 무조건 강한 불변성을 요구하고, DTO 는 변형할 수도, 불변성일 수도 있다.
// DTO 와 VO 모두 직렬화와 역직렬화 될 수 있다.

// 차이점
// DTO: 일반적으로 비즈니스 로직을 포함하지 않는다.
// VO: 비즈니스 로직을 포함할 수도 있다.
